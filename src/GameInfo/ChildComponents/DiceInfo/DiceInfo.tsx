...
import { GameContext, useActivePlayer, useDice, useDiceManagement } from "../../../Services/DataServices";
...
const dice = useDice(gameId)[0];
  ...
  return (
    <div className={styles.GameInfo} hidden={!props.active && dice?.length > 0 && dice[0] > 0}>
      <ReactDice
        numDice={2}
        ref={ref}
