...
export function Board(props: any) {
  ...
  return (
    <group {...props} dispose={null} onPointerOver={(e) => (e.stopPropagation(), console.log("hj"))}>
      ...
      <mesh geometry={nodes.FenceBottom.geometry} material={materials['Material.002']} position={[18.43, 0.49, -0.02]} rotation={[0, -Math.PI / 2, 0]} scale={[0.21, 0.5, 0.48]} />
      <mesh geometry={nodes.FenceTop.geometry} material={materials['Material.004']} position={[8.99, 0.49, -25.97]} rotation={[0, Math.PI / 2, 0]} scale={[0.21, 0.5, 0.48]} />
      <mesh geometry={nodes.FenceRight.geometry} material={materials['Material.005']} position={[25.98, 0.49, -18.34]} scale={[0.21, 0.5, 0.48]} />
      <mesh geometry={nodes.FenceLeft.geometry} material={materials['Material.001']} position={[0.02, 0.5, -19.04]} scale={[0.21, 0.5, 0.47]} />
    </group>
  )
}
