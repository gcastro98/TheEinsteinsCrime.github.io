...
export function Arrows(props: any) {
  const { nodes, materials } = useGLTF(
    `${selectPath()}/characters/Arrows.glb`
  ) as any;
  const [positionX, setPositionX] = useState(props.initialPosition.x || 0);
  const [positionY, setPositionY] = useState(props.initialPosition.y || 0);
