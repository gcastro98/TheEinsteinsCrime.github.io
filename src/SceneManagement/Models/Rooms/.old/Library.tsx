...
//           </group>
//         </group>
//         <group name="Room" position={[3.98, 0.55, -23.09]} rotation={[0, Math.PI / 2, 0]} scale={[3, 1, 4]} onPointerOver={(ev) => (ev.stopPropagation(), !show && setShow(true))} onPointerOut={(ev) => (ev.stopPropagation(), setShow(false))}>
