...
Command: npx gltfjsx@6.1.4 .\Observatory.glb
*/
...
export function Model(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/Observatory.glb')
  const { actions } = useAnimations(animations, group)
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Class">
        <group name="DoorGroup" position={[18.34, 0.53, -5.98]} rotation={[-Math.PI / 2, 0, 3.14]} scale={0.01}>
        ...
        <group name="LampLeft002" position={[23.3, 2.91, -1.48]} rotation={[-Math.PI / 2, 0, -Math.PI / 2]} scale={0.28}>
          ...
          <group name="LightLeft002" position={[-0.06, 0.26, 0.46]} rotation={[Math.PI / 2, 0, 0]} scale={0.55}>
            <pointLight name="LightLeft002_Orientation" intensity={1} decay={2} rotation={[-Math.PI / 2, 0, 0]} />
          </group>
        </group>
        <group name="LampRight002" position={[23.3, 2.92, -3.46]} rotation={[-Math.PI / 2, 0, -Math.PI / 2]} scale={0.28}>
          ...
          <group name="LightRight002" position={[-0.06, 0.26, 0.52]} rotation={[Math.PI / 2, 0, 0]} scale={0.55}>
            <pointLight name="LightRight002_Orientation" intensity={1} decay={2} rotation={[-Math.PI / 2, 0, 0]} />
          </group>
        </group>
        <group name="DoorGroup001" position={[14.95, 0.53, -3.48]} rotation={[-Math.PI / 2, 0, 1.57]} scale={0.01}>
        ...
        <group name="DoorGroup002" position={[23.08, 0.53, -2.5]} rotation={[-Math.PI / 2, 0, 1.57]} scale={0.01}>
...
useGLTF.preload('/Observatory.glb')
